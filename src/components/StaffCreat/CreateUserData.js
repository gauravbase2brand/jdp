      ...
      <div className='grid grid-cols-1   '>
        <div >
          <div className="flex flex-wrap justify-start gap-3">
            <Tooltip
              title="Create a brand-new job record 332"
              placement="topLeft"
              arrow
        ...
        <div className="relative mt-8 overflow-x-auto rounded-3xl">
          <table className="w-full bg-white">
            <thead>
              <tr
                className="bg-[#162F3D] text-left text-white"
                style={{
                  background: '#162F3D',
                }}
              >
                <th className="px-3 py-3 text-sm text-[#2B2B2B]">
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="hover:bg-gray-50">
                  <td className="px-3 py-3 text-sm text-[#2B2B2B]">
                    <input
                      type="checkbox"
                  ...
                  <td className="relative flex space-x-2 px-3 py-3 text-sm text-[#2B2B2B]">
