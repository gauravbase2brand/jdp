         ...
         <div className='grid grid-cols-1 mb-3'>
           <div className=''> 
            <div className="flex items-center md:justify-between justify-center gap-3 flex-wrap">
              ...
              <div className="grid md:grid-cols-3 grid-cols-3 md:gap-3 gap-1 ">
                <SelectOptionAnt FilterInpur="Job Type" />
                <SelectOptionAnt FilterInpur="Completion Status" />
                <SelectOptionAnt FilterInpur="Sort By" />
              </div>
            </div>
            <div className="mt-3 flex justify-items-start md:gap-10 gap-4 justify-center md:justify-start">
            ...
            <div>
     <div className="relative mt-8 overflow-x-auto rounded-3xl scrollbar-webkit">
    ...
    <tbody>
      {users.map((user) => (
        <tr key={user.id} className="hover:bg-gray-50">
          ...
          <td className="px-4 py-3 text-[#2B2B2B] md:w-auto min-w-[150px] ">{user.JobID}</td>
          <td className="px-4 py-3 text-[#2B2B2B] md:w-auto min-w-[150px]">{user.Job_Type}</td>
          <td className="px-4 py-3 text-[#2B2B2B] md:w-auto min-w-[150px]">{user.AssignedTo}</td>
          <td className="px-4 py-3 text-[#2B2B2B] md:w-auto min-w-[150px]">{user.Date_Assigned}</td>
          <td className="px-4 py-3 text-[#2B2B2B] md:w-auto min-w-[150px]">{user.Due_Date}</td>
          <td className="px-4 py-3 text-[#2B2B2B] md:w-auto min-w-[150px]">{user.Linked_Invoice}</td>
          <td className="px-4 py-3 text-[#2B2B2B] md:w-auto min-w-[150px]">{user.Billing_Status}</td>
          <td className="px-4 py-3 text-[#2B2B2B] md:w-auto min-w-[180px]">
            <span className={`rounded-full border-[1.5px] text-sm p-1.5 ${getStatusClass(user.CompletedTask)}`}>
              {user.CompletedTask}
            </span>
          </td>
