...
const CreateUserData = () => {
  ...
  const users = [
    { id: 0, name: 'John Smith', role: 'Staff', phone: '+61 2222 021 203', email: 'john@gmail.com', business: 'N/A', createdOn: '27-4-2025' },
    { id: 1, name: 'David Smith', role: 'Lead Labor', phone: '+61 2222 021 203', email: 'david@gmail.com', business: 'N/A', createdOn: '07-4-2025' },
    { id: 2, name: 'Olivia', role: 'Labor', phone: '+61 2222 021 203', email: 'olivia@gmail.com', business: 'N/A', createdOn: '15-4-2025' },
    { id: 3, name: 'Allen', role: 'Labor', phone: '+61 2222 021 203', email: 'alen@gmail.com', business: 'N/A', createdOn: '19-4-2025' },
    { id: 4, name: 'Benz', role: 'Supplier', phone: '+61 2222 021 203', email: 'bebz@gmail.com', business: 'N/A', createdOn: '08-4-2025' },
    { id: 5, name: 'Mark', role: 'Labor', phone: '+61 2222 021 203', email: 'mark@gmail.com', business: 'N/A', createdOn: '05-4-2025' },
    { id: 6, name: 'Faddy', role: 'Labor', phone: '+61 2222 021 203', email: 'faddy@gmail.com', business: 'N/A', createdOn: '10-4-2025' },
    { id: 7, name: 'Samuel', role: 'Staff', phone: '+61 2222 021 203', email: 'sam@gmail.com', business: 'N/A', createdOn: '18-4-2025' },
    { id: 8, name: 'Danial', role: 'Labor', phone: '+61 2222 021 203', email: 'danial@gmail.com', business: 'N/A', createdOn: '20-4-2025' },
    { id: 9, name: 'Jazz', role: 'Labor', phone: '+61 2222 021 203', email: 'jazz@gmail.com', business: 'N/A', createdOn: '22-4-2025' },
    { id: 10, name: 'Harper', role: 'Labor', phone: '+61 2222 021 203', email: 'harper@gmail.com', business: 'N/A', createdOn: '29-4-2025' },
    { id: 11, name: 'Hanny', role: 'Staff', phone: '+61 2222 021 203', email: 'hanny@gmail.com', business: 'N/A', createdOn: '17-4-2025' }
  ];
        ...
        <tbody>
          {users.map((user) => (
            <tr key={user.id} className="hover:bg-gray-50">
              ...
              <td className="px-4 py-3 text-[#2B2B2B]">{user.name}</td>
              <td className="px-4 py-3 text-[#2B2B2B]">{user.role}</td>
              <td className="px-4 py-3 text-[#2B2B2B]">{user.phone}</td>
              <td className="px-4 py-3 text-[#2B2B2B]">{user.email}</td>
              <td className="px-4 py-3 text-[#2B2B2B]">{user.business}</td>
              <td className="px-4 py-3 text-[#2B2B2B]">{user.createdOn}</td>
              <td className="px-4 py-3 text-[#2B2B2B] flex space-x-2 relative">
                ...
                {openTool === user.id && (
                  <div
                    ref={dropdownRef}
                    className="absolute right-0 mt-2 w-40 bg-white shadow-lg rounded-md border border-gray-300 z-10 top-[25px]"
                  >
...
<path opacity="0.8" d="M2.53963 15.1326C2.07403 15.1326 1.67559 14.9682 1.34431 14.6392C1.01303 14.3102 0.847108 13.9142 0.846543 13.4512V2.52211H0V0.840703H4.23272V0H9.31198V0.840703H13.5447V2.52211H12.6981V13.4512C12.6981 13.9136 12.5325 14.3096 12.2012 14.6392C11.8699 14.9687 11.4712 15.1332 11.0051 15.1326H2.53963ZM11.0051 2.52211H2.53963V13.4512H11.0051V2.52211ZM4.23272 11.7698H5.9258V4.20351H4.23272V11.7698ZM7.61889 11.7698H9.31198V4.20351H7.61889V11.7698Z" fill="#111827"/>
</svg>
                        </span> Delete
                    </div>
                  </div>
...
<div className="flex justify-end mt-4 gap-1 pb-6">
    <Link href="#" className="px-2 py-1 text-gray-600 border rounded-lg text-sm flex items-center rotate-180">
        <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
        </svg>
    </Link>
    {['1', '2', '3', '...', '21'].map((item, index) => (
        <Link key={index} href="#" className="px-2 py-1 text-gray-600 border rounded-lg text-sm flex items-center">
            {item}
        </Link>
    ))}
    <Link href="#" className="px-2 py-1 text-gray-600 border rounded-lg text-sm flex items-center">
        <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
        </svg>
    </Link>
